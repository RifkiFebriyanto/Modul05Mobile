...
public class MainActivity extends AppCompatActivity implements LocationListener {
        ...
        spinnerCari.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (position != 0) {
                    ...
                    //proses eksekusi API key dari google cloud
    ...
    private void initMap() {
        ...
        //bagian pemeriksaan hak akses atau permission
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        //bagian untuk menampilkan jumlah lokasi terdekat dari user
        @Override
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                BitmapDescriptor pinDrop = BitmapDescriptorFactory.fromResource(R.drawable.lct_pin);
